...
export default function Messages() {
  ...
  return (
    <div className="container my-5 d-flex flex-column justify-content-between" style={{ minHeight: '70vh' }}>
      <div>
        <h2 className="mb-4 text-center fw-bold">All Messages</h2>
        {messages.length === 0 ? (
          <div className="d-flex justify-content-center">
            <div className="border rounded-4 p-4 shadow-sm bg-white text-center w-100" style={{ maxWidth: '500px' }}>
<h5 className="fw-bold mb-2">📭 No messages yet</h5>
<p className="text-muted">When users send messages, they will show up here.</p>
            </div>
          </div>
        ) : (
          <div className="row g-3">
            {currentMessages.map((msg) => (
              <div key={msg._id} className="col-md-12">
                <div
                  className="border rounded-4 p-4 shadow-sm bg-white position-relative"
