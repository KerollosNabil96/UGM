...
export default function Settings() {
    ...
    // 3. useEffect بعد جميع استدعاءات Hooks الأخرى
    useEffect(() => {
    ...
    // 4. الشروط بعد جميع استدعاءات Hooks
    if (shouldRedirect) {
                ...
                >
                    <div className="container py-3">
                        ...
                        <p className='text-center mb-4 fs-4 tw-text-gray-600 dark:tw-text-white text-sm'>
                            In this section, you can edit your personal information and update your password.
                        </p>
                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    ...
                                    <div className="parent md:tw-flex gap-2">
                                        <div className="collegechild w-100">
                                            <input 
                                                type="text" 
                                                placeholder='Update college or Institute' 
                                                id='college' 
                                                name='college'
                                                onChange={formik.handleChange} 
                                        ...
                                        <div className="priestName-child w-100">
                                            <input 
                                                ...
                                                id='priestName' 
                                                name='priestName' 
                                                placeholder='Update priest name'
                                    ...
                                    <div className="parent md:tw-flex gap-2">
                                        ...
                                        <div className="Address2-child w-100">
                                            <input 
                                                ...
                                                id='Address2' 
                                                name='Address2' 
                                                placeholder='Update Address 2 (if available)'
                                                className='form-control w-100 mt-3' 
                                                onChange={formik.handleChange} 
                                    ...
                                    <div className="parent md:tw-flex gap-2">
                                        <div className="mobileNumber1child w-100">
                                            <input 
                                                type="text" 
                                                placeholder='Update mobile number 1' 
                                                id='mobileNumber1' 
                                                name='mobileNumber1'
                                                onChange={formik.handleChange} 
                                        ...
                                        <div className="mobileNumber2-child w-100">
                                            <input 
                                                ...
                                                id='mobileNumber2' 
                                                name='mobileNumber2' 
                                                placeholder='Update mobile number 2 (if available)'
                                                className='form-control w-100 mt-3 py-2' 
                                                onChange={formik.handleChange} 
                                    ...
                                    <div className="parent md:tw-flex gap-2">
                                        ...
                                        <div className="profession-child w-100">
                                            <input 
                                                ...
                                                id='profession' 
                                                name='profession' 
                                                placeholder='Update profession (if available)'
                                                className='form-control w-100 mt-3 py-2' 
                                                onChange={formik.handleChange} 
