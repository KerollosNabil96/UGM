...
//     const eventToDeleteFrom = events.find(e => e._id === eventId);
//     if (!eventToDeleteFrom) {
//       setError('Event not found');
//       return;
//     }

//     const eventDate = new Date(eventToDeleteFrom.date);
//     const today = new Date();
//     today.setHours(0, 0, 0, 0);

//     const userToRefund = selectedEvent?.reservedUsers.find(
//       user => user.bookingInfo?.bookingId === bookingId
//     );

//     const shouldRefund =
//       userToRefund &&
//       userToRefund.bookingInfo?.paymentMethod === 'wallet' &&
//       eventDate > today;
...
//     if (shouldRefund) {
//       const refundAmount = eventToDeleteFrom.price;
//       const userId = userToRefund._id;

//       await axios.put(
//         `https://ugmproject.vercel.app/api/v1/user/updateWallet/${userId}`,
//         {
//           amount: refundAmount,
//           operation: 'add',
//           description: 'Refund due to booking cancellation',
//         },
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
